...
pilot_locations = [
    # Floor 1 (LC3-1)
    {"id": "LC3_QR1", "name": "จุดที่ 1: โถงบันไดกลาง ชั้น 1"}, 
    {"id": "LC3_QR2", "name": "จุดที่ 2: หน้าห้อง 114 ชั้น 1"}, 
    {"id": "LC3_QR3", "name": "จุดที่ 3: ข้างห้อง 101 ชั้น 1"},
    {"id": "LC3_QR4", "name": "จุดที่ 4: ข้างห้อง 128 ชั้น 1"}, 
    
    # Floor 2 (LC3-2)
    {"id": "LC3_QR5", "name": "จุดที่ 5: โถงกลาง ชั้น 2"},
    {"id": "LC3_QR6", "name": "จุดที่ 6: หน้าห้อง 214 ชั้น 2"},
    {"id": "LC3_QR7", "name": "จุดที่ 7: หน้าห้อง 232 ชั้น 2"},
    {"id": "LC3_QR8", "name": "จุดที่ 8: หน้าห้อง 227 ชั้น 2"}, 
]
